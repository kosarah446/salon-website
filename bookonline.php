...
<form id="msform" action = "bookonline_confirmation.php" method ="POST">
  ...
  <fieldset>
    ...
    <input type="button" name="next" class="next action-button" value="Next" onkeydown="return event.key != 'Enter';">
    <br>
        <a href = "search_booking.php"><h3 class="link"> Already have an appointment? </h3> 
</a>
  </fieldset>

  <fieldset>
    <h2 class="fs-title">Request an appointment</h2>
      ...
      <div class="form-group row">
        <label for="category-id" class="col-sm-3 col-form-label text-sm-right labels">Category:</label>
        <div class="col-sm-9">
          <select name="category_id" id="category-id" class="form-control">
            ...
            while($row = $results_categories->fetch_assoc())
            {
        ...
        <div class="col-sm-9">
          <select name="service_id" id="service-id" class="form-control">
           ...
           <?php
            ...
            <div class="form-group row">
        <label for="award-id" class="col-sm-3 col-form-label text-sm-right labels">Comments:</label>
        <div class="col-sm-9">
          <textarea name="comment" id="comment-id" class="form-control" placeholder ="Please put your availability here."></textarea>
        </div>
      </div> <!-- .form-group -->
...
<div class="row mt-3">
    ...
    <div class="row mt-3">
      <div class="col-4 text-right">Services:</div>
      <div class="col-8">
         <!-- PHP Output Here -->
        <?php
    ...
    <div class="row mt-3">
      <div class="col-4 text-right">Comments:</div>
      <div class="col-8">
        <!-- PHP Output Here -->
        <?php
